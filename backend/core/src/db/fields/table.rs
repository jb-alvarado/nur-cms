...
impl FromStr for Table {
    ...
    fn from_str(input: &str) -> Result<Self, Self::Err> {
        match input {
            ...
            "content_nodes" => Ok(Self::ContentNodes),
            "content_node_media" => Ok(Self::ContentNodeMedia),
            "content_node_templates" => Ok(Self::ContentNodeTemplates),
...
impl fmt::Display for Table {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Self::ContentNodes => write!(f, "content_nodes"),
            Self::ContentNodeMedia => write!(f, "content_node_media"),
            Self::ContentNodeTemplates => write!(f, "content_node_templates"),
