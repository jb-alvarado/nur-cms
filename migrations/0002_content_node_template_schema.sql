...
CREATE UNIQUE INDEX IF NOT EXISTS idx_content_node_templates_name ON content_node_templates (name);

CREATE INDEX IF NOT EXISTS idx_content_nodes_template_id ON content_nodes (template_id);

CREATE INDEX IF NOT EXISTS idx_content_nodes_entry_id ON content_nodes (entry_id);
