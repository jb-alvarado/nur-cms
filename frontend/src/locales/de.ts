export default {
    ...
    user: {
        ...
        member: 'Benutzer',
        role: 'Rolle',
        rolesFailed: 'Benutzerrollen konnten nicht geladen werden.',
        requiredFields: 'Bitte alle Felder ausfüllen.',
        passwordTooLong: 'Das Passwort darf höchstens 1024 Byte lang sein.',
        loginAlreadyUsed: 'Benutzername oder E-Mail-Adresse wird bereits verwendet.',
