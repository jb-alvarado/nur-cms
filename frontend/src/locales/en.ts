export default {
    ...
    markdownHelp: {
        ...
        autolink: 'Autolink',
        footnote: 'Footnote',
        inlineFootnote: 'Inline footnote',
        underline: 'Underline',
        highlight: 'Highlight',
        insert: 'Insert',
    ...
    user: {
        ...
        member: 'User',
        role: 'Role',
        rolesFailed: 'Could not load user roles.',
        requiredFields: 'Please fill in all fields.',
        passwordTooLong: 'Password must be at most 1024 bytes long.',
        loginAlreadyUsed: 'Username or email is already in use.',
